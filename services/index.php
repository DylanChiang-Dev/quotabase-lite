...
<div class="main-content">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; gap: 12px; flex-wrap: wrap;">
        <div style="display: flex; gap: 12px; flex: 1;">
            <!-- 搜索框 -->
            <form method="GET" action="/services/index.php" style="display: flex; gap: 8px; flex: 1; max-width: 400px;">
                <input
                    type="text"
                    name="search"
        ...
        <div style="display: flex; gap: 12px;">
            <a href="/services/new.php" class="btn btn-primary">新建服务</a>
        </div>
    </div>
                        ...
                        <tr style="border-bottom: 1px solid var(--border-color); hover: var(--bg-secondary);">
                            ...
                            <td style="padding: 16px 12px; text-align: center;">
                                <div style="font-size: 13px; color: var(--text-tertiary);">
                                    <?php echo format_date($service['created_at']); ?>
                                </div>
                            </td>
                            <td style="padding: 16px 12px; text-align: center;">
                                <div style="display: flex; gap: 8px; justify-content: center;">
                                    <a
                                        href="/services/edit.php?id=<?php echo $service['id']; ?>"
